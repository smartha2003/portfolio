    ...
    <nav className="fixed top-0 left-0 w-full bg-transparent shadow-md py-4 z-10">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="ml-auto space-x-20">
          ...
          <a href="#about" className="text-light-pink hover:text-[#f472b6] text-shadow-lg">About</a>
          <a href="#projects" className="text-light-pink hover:text-[#f472b6] text-shadow-lg">Projects</a>
          <a href="#contact" className="text-light-pink hover:text-[#f472b6] text-shadow-lg">Contact</a>
          <a href="/ShubhadaMartha_Resume_2024_webDev.pdf" target="_blank" rel="noopener noreferrer">
            <button className="border-2 border-white text-light-pink text-shadow-lg px-4 py-2 rounded bg-transparent hover:bg-[#f472b6] hover:text-dark-slate-grey transition duration-300 hover:animate-bounce">
              Resume
            </button>
          </a>
        </div>
